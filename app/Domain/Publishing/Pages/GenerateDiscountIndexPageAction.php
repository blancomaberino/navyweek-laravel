...
final class GenerateDiscountIndexPageAction
{
    ...
    public function __invoke(): int
    {
        ...
        $page = $this->pages->upsertPillarPage('discount-index', PagePaths::root('discounts'), [
            ...
            'slug' => 'discount',
            'title' => $title,
            'h1' => 'MILITARY DISCOUNTS',
            'meta_description' => self::META_DESCRIPTION,
            'key_facts' => [
                'title' => 'Military Discounts — Key Facts',
                'facts' => [
                    ['label' => 'Brands covered', 'value' => (string) $count],
                    ['label' => 'Typical discount', 'value' => '10–25% off, verified free through ID.me, GovX, or SheerID'],
                    ['label' => 'Who qualifies', 'value' => 'Active duty, veterans, retirees, Guard and Reserve — many brands include spouses and dependents'],
                    ['label' => 'Cost to verify', 'value' => 'Free — verification services never charge the customer'],
                ],
                'source' => ['label' => 'ID.me — military verification', 'url' => 'https://www.id.me/'],
            ],
            'trust_page_label' => 'Military discounts directory',
            ...
            'editorial_review_cadence' => "Listings are re-verified whenever a brand's offer changes and at every page update.",
