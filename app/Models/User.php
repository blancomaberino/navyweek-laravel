 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Page> $authoredPages
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Page> $reviewedPages
 */
