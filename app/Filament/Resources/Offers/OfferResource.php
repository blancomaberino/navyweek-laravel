...
use App\Filament\Resources\Offers\RelationManagers\RedemptionStepsRelationManager;
...
class OfferResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'internal_label';
    ...
    {
        return ['internal_label', 'headline_discount'];
    }
    ...
    public static function getRelations(): array
    {
        return [
            ...
            RedemptionStepsRelationManager::class,
        ];
    }
